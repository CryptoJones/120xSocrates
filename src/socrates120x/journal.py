...
# Canonical entry filename: YYYY-MM-DD.md. `_list` / `_show_latest` must not
# pick up unrelated .md files (notes.md, ideas.md, README.md) an operator may
# have dropped into the journal dir.
